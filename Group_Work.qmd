...
A second way to assess whether Airbnb is “out of control” is to examine the commercialisation of London’s STR market. Prior research shows that when STR activity shifts from occasional home-sharing to investment-driven, multi-property operations, it withdraws units from the long-term rental market and contributes to rent inflation, displacement and neighbourhood change[@wachsmuth2018rentgap; @bivens2019airbnb]. Thus, commercialisation is not only an economic shift but a mechanism that increases housing pressure.
