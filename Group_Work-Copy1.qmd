...
```{python}
#| echo: True 
## 20 Calculate host's listing and proportion
...
```{python}
#| echo: True 
## 21 Map distribution of multi-listing hosts
...
```{python}
#| echo: True 
## 22 Generate point data + spatial join
...
```{python}
#| echo: True 
## 23 #23 Plot professional landlord listings on the map
